...
public class Easy_Stage extends AppCompatActivity {
    ...
    private int easyQuestionIndex = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_easy_stage);
...
//        loads the Question from Easy Level
    ...
    public void easyLoadQuestion(){
//      Randomize the options in buttons
        int randomIndex = new Random().nextInt(Easy_Difficulty.Easy_Options.length);
        String[] optionSet = Easy_Difficulty.Easy_Options[easyQuestionIndex];
        List<String> optionList = Arrays.asList(optionSet);
        Collections.shuffle(optionList);


        tvCounter.setText((easyQuestionIndex + 1) + "/" + Easy_Difficulty.Easy_Country.length);
        tvQuestion.setText("What is the capital of \n" +
                (Easy_Difficulty.Easy_Country[easyQuestionIndex]) + "?");
    ...
    private void answerChecker(String selectedOption) {
        String correctAnswer = Easy_Difficulty.Easy_Capital[easyQuestionIndex];
        ...
        easyQuestionIndex++;
        if (easyQuestionIndex < Easy_Difficulty.Easy_Country.length) {
            easyLoadQuestion();
        } else {
            // End of questions
            ...
            builder.setTitle("Quiz Completed")
                    ...
                    .setNegativeButton("No", (dialog, which) -> {
                        ...
                        Intent intent = new Intent(Easy_Stage.this, homepage.class);
